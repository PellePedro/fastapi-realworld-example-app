...
from app.api.routes import authentication, bookmarks, comments, profiles, tags, users
...
router.include_router(bookmarks.router, tags=["bookmarks"], prefix="/bookmarks")
